...
CATEGORY_RULES = [
    ...
    # Groceries (handles MobilePay prefix: "MobilePay Coop App", "MobilePay REMA1000 ...")
    ...
    (r"Microsoft|OPENAI|CLAUDE|ANTHROPIC|Google\s*\*?Google\s*One|Google\s*Play", "Øvrige udgifter", "Abonnement"),
    # Personal care
